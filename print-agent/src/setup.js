...
try {
  const values = {
    ...
    PRINTER_NAME: await ask('Nome exato da impressora padrão (balcão / contas / recibos)'),
    STATION_PRINTERS: await ask('Impressoras extras por estação, ex: kds:Nome1,bar:Nome2,churrasqueira:Nome3 (deixe em branco se só tiver uma impressora)'),
